...
export type MarketOHLCVHistoryParams = SDKInput<typeof MarketOHLCVHistoryParamsSchema, 'blockchain'>;
export type MarketOHLCVHistoryInferType = z.infer<typeof MarketOHLCVHistoryParamsSchema>;

export const MarketOHLCVHistoryParamsSchemaOpenAPI = createOpenAPIParams(MarketOHLCVHistoryItemSchema, {
  omit: ['blockchain'],
  describe: {
    address: 'Pool/market contract address',
